...
<body class="text-center">
	...
	<!--       <img class="mb-4" src="../../assets/brand/bootstrap-solid.svg" alt="" width="72" height="72"> -->
	      <h1 class="text-secondary h3 mb-3 font-weight-normal">Accedi al Sistema</h1>
	      <label for="inputUsername" class="text-secondary sr-only">Username</label>
	      <input type="text" name="inputUsername" id="inputUsername" class="form-control" placeholder="Login" required autofocus>
	      <label for="inputPassword" class="text-secondary sr-only">Password</label>
